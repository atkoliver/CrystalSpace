...
public class SpaceConfig {
    ...
    public static void loadConfig(ConfigFile configFile) {
        fileMap.put(configFile, new File(Bukkit.getServer().getPluginManager().getPlugin("DuzySpace").getDataFolder(), configFile.getNameWithLocation()));
